...
public class Report {
    ...
    // Constructor
    public Report(String titleFacility, String requestedBy, String purpose, LocalDateTime date, String timeSlot, LocalDateTime requestedAt, String groupDirector, String facilityMan) {
